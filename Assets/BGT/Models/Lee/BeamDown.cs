...
public class BeamDown : MonoBehaviour
{
    ...
    private float rotationSpeed = 5f; // 초당 회전할 각도 (예: 20도/초)

    private Quaternion initialRotationBeam1; // Leg의 초기 월드 회전
    private Quaternion initialRotationBeam2; // Leg2의 초기 월드 회전
    ...
    void Update()
    {
        ...
        BeamNextNum.transform.rotation = Quaternion.RotateTowards(BeamNextNum.transform.rotation, targetRotationBeam2, 0.5f * rotationSpeed * Time.deltaTime);
    }
}